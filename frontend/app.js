function consulta_general(){
    ...
    <td><button type='button' class="btn btn-info" onclick="location.href ='edit.html?variable1=${data.baul[i].id_baul}'">  <img src='imagenes/delete.png' height ='30' width='30'/></button></td>
    <td><button type='button' class="btn btn-warning" onclick="eliminar(${data.baul[i].id_baul})"> <img src='imagenes/editar.png' height ='30' width='30'/></button></tr>`
    }
